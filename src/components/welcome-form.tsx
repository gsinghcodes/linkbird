...
import { signInWithGoogle } from "./login-form"
...
export function WelcomeForm({
    ...
    return (
        <div className={cn("flex flex-col shadow-2xl gap-6", className)} {...props}>
            <Card>
                <CardHeader className="text-center">
                    <CardTitle className="text-xl">Continue with an account</CardTitle>
                    <CardDescription>
                        You must login or register to continue
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    <div className="grid gap-6">
                        <div className="flex flex-col gap-4">
                            <Button variant="outline" type="button" onClick={signInWithGoogle} className="rounded-2xl w-full">
